...
<Card.Root class="mx-auto w-full max-w-sm">
    <Card.Header class="text-center">
        ...
        <Card.Description class="text-md">Enter your email or username below to login to your account
        </Card.Description>
    </Card.Header>
    <Card.Content>
            ...
            <div class="grid gap-4">
                ...
                <div class="grid gap-2">
                    <div class="flex items-center">
                        <Label for="password-{id}" class="text-md">Password</Label>
                        <a href="/reset-password"
                           class="ml-auto inline-block text-md underline">
                ...
                <Button type="submit" class="w-full text-md" disabled={isLoading}>
