...
use crate::api::public::series_handlers::{
    ...
    fetch_updated_series_chapter_handler, get_all_categories_handler, rate_series_handler,
    record_series_view_handler, user_search_series_handler,
};
use crate::api::public::user_handlers::{
...
pub fn auth_api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/register-new-user", post(register_new_user_handler))
        .route("/refresh-access-token", post(refresh_access_token_handler))
...
pub fn general_api_routes() -> Router<AppState> {
    ...
    let public_series_api_routes = Router::new()
        ...
        .route("/series/search", get(user_search_series_handler))
        .route(
            "/series/details/{id}",
    ...
    let comments_api = Router::new()
        ...
        .route(
            ...
            get(get_chapter_comment_handler).post(create_chapter_comment_handler),
        )
        .route(
            "/comments/{id}/edit",
